...
function cfmutils.buildMenu()
	...
	local options = {
		{ type = "header", name = "Settings" },
		{
			...
			setFunc = function(value)
				cfmutils.Chat:Print(
					"Addon " .. (cfmutils.savedVars.enabled and "|caf0000Disabled|r" or "|c00a000Enabled|r")
				)
			...
			controls = {
				{
					...
					getFunc = function()
						return cfmutils.savedVars.MarkerStyle
					end,
				...
				},
				{
					...
					width = "half",
					getFunc = function()
						return cfmutils.savedVars.MarkerColor[1],
							cfmutils.savedVars.MarkerColor[2],
							cfmutils.savedVars.MarkerColor[3]
					end,
					...
					default = function()
						return cfmutils.defaults.MarkerColor[1],
							cfmutils.defaults.MarkerColor[2],
							cfmutils.defaults.MarkerColor[3]
					end,
				},
				{
					type = "slider",
			...
			controls = {
				{
					...
					getFunc = function()
						return cfmutils.savedVars.ArrowStyle
					end,
					setFunc = function(var)
				...
				},
				{
					...
					width = "half",
					getFunc = function()
						return cfmutils.savedVars.ArrowColor[1],
							cfmutils.savedVars.ArrowColor[2],
							cfmutils.savedVars.ArrowColor[3]
					end,
					setFunc = function(r, g, b)
					...
					default = function()
						return cfmutils.defaults.ArrowColor[1],
							cfmutils.defaults.ArrowColor[2],
							cfmutils.defaults.ArrowColor[3]
					end,
				},
				{
					type = "slider",
		...
		{ type = "header", name = "Trial Specific" },
		{
			type = "submenu",
			...
			controls = {
				{
					...
					getFunc = function()
						return cfmutils.savedVars.AsylumTrackMini
					end,
					setFunc = function(var)
				...
				},
				{
					...
					getFunc = function()
						return cfmutils.savedVars.AsylumShowKite
					end,
					setFunc = function(var)
						cfmutils.savedVars.AsylumShowKite = var
						AS.Reset()
					end,
				},
				{
				...
				},
				{
					...
					getFunc = function()
						return cfmutils.savedVars.AsylumLaneAlwaysShowStart
					end,
					setFunc = function(var)
						cfmutils.savedVars.AsylumLaneAlwaysShowStart = var
						AS.Reset()
					end,
				},
			},
		},
		{
			...
			controls = {
				{ type = "header", name = "Trash" },
				{
					...
					getFunc = function()
						return cfmutils.savedVars.KynesTrackInfuse
					end,
					setFunc = function(var)
						cfmutils.savedVars.KynesTrackInfuse = var
					end,
				},
				{ type = "header", name = "Vrol" },
				{
					type = "checkbox",
					...
					getFunc = function()
						return cfmutils.savedVars.KynesTrackHealingFumes
					end,
					setFunc = function(var)
						cfmutils.savedVars.KynesTrackHealingFumes = var
					end,
				},
				{ type = "header", name = "Falgravn" },
				{
					type = "checkbox",
					...
					getFunc = function()
						return cfmutils.savedVars.KynesTrackMini
					end,
					setFunc = function(var)
						cfmutils.savedVars.KynesTrackMini = var
				...
				},
				{
					...
					getFunc = function()
						return cfmutils.savedVars.KynesTrackHemorrhage
					end,
					setFunc = function(var)
				...
				},
				{
					...
					getFunc = function()
						return cfmutils.savedVars.KynesBloodCleave
					end,
					setFunc = function(var)
						cfmutils.savedVars.KynesBloodCleave = var
					end,
				},
				{
					type = "checkbox",
					...
					getFunc = function()
						return cfmutils.savedVars.KynesPositionOveride
					end,
					setFunc = function(var)
						cfmutils.savedVars.KynesPositionOveride = var
						KA.Reset()
					end,
				},
				{
	...
	if cfmutils.savedVars.debugValid then
		options[#options + 1] = { type = "header", name = "Debug Settings" }
		options[#options + 1] = {
			type = "checkbox",
			name = "Debug",
			tooltip = "Debug Mode",
			...
			setFunc = function(value)
				cfmutils.Chat:Print(
					"Debug mode " .. (cfmutils.savedVars.debugEnabled and "|caf0000Disabled|r" or "|c00a000Enabled|r")
				)
